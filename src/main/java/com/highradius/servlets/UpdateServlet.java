...
public class UpdateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (slNo != 0 && customerOrderID != 0 && salesOrg != 0 && distributionChannel != null
                && division != null && purchaseOrderType != null
            ...
            boolean updated = dao.updateInvoice(invoice);
            if (updated) {
                response.getWriter().append("Updated data");
            } else {
                response.getWriter().append("Error in update");
            }
        } else {
